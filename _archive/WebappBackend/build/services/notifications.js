...
exports.notifyStreamEnded = exports.notifyRecordingReady = exports.notifyStreamStarted = void 0;
 ...
 */
async function notifyStreamStarted(parentEmail, childName, streamUrl, sessionId) {
    if (!process.env.SENDGRID_API_KEY) {
...
exports.notifyStreamStarted = notifyStreamStarted;
/**
 * Send notification when recording is ready
 */
async function notifyRecordingReady(parentEmail, childName, recordingUrl, sessionId, duration) {
    if (!process.env.SENDGRID_API_KEY) {
...
exports.notifyRecordingReady = notifyRecordingReady;
/**
 * Send notification when stream ends
 */
async function notifyStreamEnded(parentEmail, childName, sessionId, duration) {
    if (!process.env.SENDGRID_API_KEY) {
...
exports.notifyStreamEnded = notifyStreamEnded;
